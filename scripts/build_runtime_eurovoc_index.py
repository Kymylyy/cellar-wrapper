#!/usr/bin/env python3
"""Build packaged runtime EuroVoc index from research snapshot."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build runtime EuroVoc index JSON for package data.")
