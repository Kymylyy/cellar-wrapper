...
COMMANDS: list[CommandSpec] = [
    ...
    CommandSpec("relations", "get-proposals-to-change", "get_proposals_to_change", requires_celex=True, has_since=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    ...
    CommandSpec("relations", "get-article-annotations", "get_article_annotations", requires_celex=True, has_limit_offset=True),
    ...
    CommandSpec("monitoring", "new-proposals-to-change", "new_proposals_to_change", requires_celex=True, requires_since=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
