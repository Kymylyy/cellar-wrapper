...
COMMANDS: list[CommandSpec] = [
    ...
    CommandSpec("lifecycle", "get-consolidated-versions", "get_consolidated_versions", requires_celex=True, has_since=True, has_lang=True, has_limit_offset=True),
    CommandSpec("lifecycle", "get-corrigenda", "get_corrigenda", requires_celex=True, has_since=True, has_lang=True, has_limit_offset=True),
    CommandSpec("lifecycle", "get-nims", "get_nims", requires_celex=True, has_since=True, has_lang=True, has_limit_offset=True),
