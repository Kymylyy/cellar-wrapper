...
COMMANDS: list[CommandSpec] = [
    ...
    CommandSpec("relations", "get-amendments", "get_amendments", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-repeals", "get_repeals", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-citations", "get_citations", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-delegated-acts", "get_delegated_acts", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-completing-acts", "get_completing_acts", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-proposals-to-amend", "get_proposals_to_amend", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-adopted-act", "get_adopted_act", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-related-works", "get_related_works", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
    CommandSpec("relations", "get-other-relations", "get_other_relations", requires_celex=True, has_resource_type=True, has_lang=True, has_limit_offset=True),
